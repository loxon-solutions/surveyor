...
export class Environment {
    ...
    static createMainEnvironment(parserOptions: AbstractParser[], writerOptions: AbstractWriter[]): Environment {
    ...
    private initializeParamOptions() {
        ...
        this.parserOptions.forEach(p => p.getParamOptions().forEach(o => { o.description += ` Used by ${p.constructor.name}.`; this.paramOptions.push(o)}));
        this.writerOptions.forEach(p => p.getParamOptions().forEach(o => { o.description += ` Used by ${p.constructor.name}.`; this.paramOptions.push(o)}));
    }
